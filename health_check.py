...
from error_handling import HealthChecker, ErrorHandler
...
class SystemHealthChecker:
        ...
        for component_name, check_func in components:
            try:
                ...
                self.error_handler.handle_error(
                    f"health_check_{component_name}", e,
                    recoverable=True,
        ...
        try:
            ...
            return HealthCheckResult(
                ...
                details={
                    ...
                    "integrity_check": str(integrity_result[0]) if integrity_result else "failed",
    ...
    def _check_disk_space(self) -> HealthCheckResult:
        ...
        try:
            ...
            return HealthCheckResult(
                ...
                healthy=healthy,
                response_time_ms=None,
                error_message=None if healthy else f"Low disk space: {free_mb:.1f}MB free",
                details={
    ...
    def _check_tts_system(self) -> HealthCheckResult:
        ...
        try:
            ...
            return HealthCheckResult(
                ...
                details={
                    "available_methods": ", ".join(tts_methods) if tts_methods else "none",
    ...
    def log_health_summary(self, results: Dict[str, HealthCheckResult]) -> None:
        ...
        self.logger.info(f"System Health Check Results (Overall: {'HEALTHY' if overall_healthy else 'UNHEALTHY'})")
        ...
        for component, result in results.items():
            ...
            if result.healthy:
                ...
                self.logger.warning(f"  {status} {component}: {result.error_message}{response_time}")
