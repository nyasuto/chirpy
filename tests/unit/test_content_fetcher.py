...
class TestContentFetcher:
    ...
    def test_process_empty_summary_article_success(self, test_config, mock_openai_client):
    ...
    def test_process_empty_summary_article_fetch_failed(self, test_config, mock_openai_client):
    ...
    def test_process_article_with_translation_english(self, test_config, mock_openai_client):
    ...
    def test_process_article_with_translation_japanese(self, test_config, mock_openai_client):
    ...
    def test_process_article_with_translation_no_summary(self, test_config, mock_openai_client):
