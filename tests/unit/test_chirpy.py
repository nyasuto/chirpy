...
class TestChirpyReader:
    ...
    def test_process_article_for_reading_no_translation_needed(self, mock_chirpy_reader):
    ...
    def test_process_article_for_reading_unknown_language(self, mock_chirpy_reader, mock_openai_client):
    ...
    def test_process_article_for_reading_exception_handling(self, mock_chirpy_reader, mock_openai_client):
        """Test exception handling in article processing."""
        with patch('content_fetcher.openai') as mock_openai:
            mock_openai.OpenAI.return_value = mock_openai_client
            
            with patch.object(mock_chirpy_reader.content_fetcher, 'process_article_with_translation') as mock_process:
